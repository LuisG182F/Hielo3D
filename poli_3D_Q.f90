...
integer                                 ::   delta,sip1,sip2,sip3,iii,jjj,kkk,i,j,k,s, BG_part0,BG_part1,BG_part2,BG_part
...
integer,dimension(filas*columnas*ancho) ::   vect,orient1
